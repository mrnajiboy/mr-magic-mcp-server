...
- find algo for best results. ([f01c725](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/f01c725e6dd7ffe32b24ef1c346c4c5c3771645b))

### Documentation

- prettier ([300f933](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/300f933f4ab6d4cde4365f7349db0f44254bd725))
...
- security risks ([ae30518](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/ae30518ee33aed6cf9119777cadc1b51baa8f87e))
...
- push_catalog_to_airtable tool, catalog cache, Airtable integration, npx install docs (v0.1.5) ([82d99be](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/82d99bec1f410b8b3630c27cb2ac1f7cbfda2e4c))

### Bug Fixes

- apply Render host/port binding to JSON HTTP server too (v0.1.10) ([a6d63f2](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/a6d63f2751b00894d98b336e8ece32054d228c9b))
- auto-enable sessionless mode on Render to fix multi-instance session loss ([41a501f](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/41a501f78dc1e02d60d8b7c747a6f0dfa744aa1a))
- DNS rebinding Host validation for http-server.js (v0.1.11) ([52405be](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/52405bed74e17133a97a3e2e9c9650dcf6d91bf8))
- DNS rebinding protection for 0.0.0.0 binding (v0.1.10) ([43ca85f](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/43ca85ff9cba5864e379aeb1e459af7fabe296d0))
- hierarchy change ([b823bfd](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/b823bfd3425b5236d0d91676072c41d28999cdcc))
- per-session Streamable HTTP transport + legacy SSE fallback (v0.1.17) ([92e5ffc](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/92e5ffcff02f433a41f1a7f832603808a10b1bc3))
- Render deployment — 0.0.0.0 binding, PORT env, duplicate startup (v0.1.10) ([ab76574](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/ab76574c94f3b15c946981da8b71777e8cf6fa64))
- update mcp streamable http service wording for clarity ([2c854eb](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/2c854eb58d362f47463c9ed0d099c3510b4f896e))
- update prompts ([e272d78](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/e272d78f98c83ab0bca403a6ad7d647559001e7d))

### Documentation

- add npm version and downloads badges to README ([f797717](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/f797717c3d7d0cf0515b53f0be5abbd0ccf2656a))
- added disclaimers to README ([c6bc8da](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/c6bc8da4ffa7c7be5b76a23a7f5c08be78f526bf))
- airtable safe mode added ([90b3d78](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/90b3d78eb8f57197fc462780531e6b48a54b2c55))
- clarify local download base URL ([15acdc1](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/15acdc1f7ac246ed959b37b19fefa2196958f2fd))
- clarify stdio redis download requirements ([343489f](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/343489f5e5ab3e46f72abc1324861c8d5a5a0464))
- cleanup README.md for lint ([7c920ac](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/7c920ac8fedd42a3019573beb3206e7a863d6cb9))
- disclaimer update ([dd6d28b](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/dd6d28b72931d1a399362f208bdfa48d4953437c))
- document export env vars and switch to undici ([ad86b76](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/ad86b7608ec8a734c4b389e480e300084084c2f7))
- document PORT env ([d1e91d0](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/d1e91d0abf03023814cd320b4cd2564737dfd459))
- document sessionless mode (README, .env.example, CHANGELOG) - v0.1.23 ([9114abe](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/9114abe19ee97293936a64d8ba00750ff6f728f8))
- env.example and README updates ([61f6f9f](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/61f6f9f671801896b69de30997ea6e63cfd0fbd2))
- full README refactor + CHANGELOG cleanup (v0.1.11) ([0a9297a](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/0a9297afece6ee374ffd058a3e5d64aac11173f6))
- overhaul MCP Client Configuration — local vs remote, TypingMind guide, bump 0.1.20 ([149903e](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/149903e325d0fdb2904bd50f11fd277579d62cda))
- readme cleanup ([deced6d](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/deced6de5ec9a1e255ac3906b224c0c11a4ced2f))
- README cleanup ([b626e98](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/b626e98c68aadde34aacd8cab046f3470a6e0178))
- README.md cleanup ([c26cd7b](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/c26cd7b98a506cf4316c92687f934537ab6ad894))
- README.md cleanup ([5a2f9ba](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/5a2f9ba8b557e9c1d5fcee3437ff7c835969b467))
- README.md cleanup ([28da10c](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/28da10c87e8d0a72b9e5692b00da871540b8ee54))
- README.md cleanup ([0add586](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/0add586b7015928e2d400491ed8ff48fed7ed914))
- README.md cleanup ([24fa064](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/24fa06489a362a57507d50be56d89b1ce881e1db))
- slight formatting fix ([901aaaa](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/901aaaab99f55d00936bf5f3d25e16dfe3fe082d))
- testing documentation ([cf3d9db](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/cf3d9db9ad7d03ff5a431908762689d898785867))
- update .env.example with new env vars and instructions ([b69941a](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/b69941a72eb2cb04fe78b26d6bb004325a070fe1))
- update disclaimers ([abbedfd](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/abbedfd9122e6a458b67e05ee8da6615a974f993))
- Update PORT usage on downloads ([5846375](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/58463757bcc22ae3aefe60ef4a03595d91f1bd8b))
- Update README for lint readiness ([778e06a](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/778e06ae3e997211cd0516a2ed476be4d168b1e4))
- update README.md ([1e8c8f9](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/1e8c8f966fc264326bfb9df8d487e596a421dc96))
- update README.md ([ccb0a59](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/ccb0a5964ee4a0e0a3ef12def5c9032cb143cbc5))
- update README.md ([c2ea587](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/c2ea5874b358850e0ae10e9e01356a5430c85f69))
- update README.md ([99b656c](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/99b656caf206d34de0cb7dcf845f263d992d8c71))
- Update README.md ([4a3ec7d](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/4a3ec7d128a3698b4ba45473f1649a845f3874ef))
- update README.md for installation process. ([683b832](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/683b832bd448af1ad1e8315b4fd03aff0874528c))
- update README.md formatting ([0423929](https://github.com/mrnajiboy/mr-magic-mcp-server/commit/04239296c61a2f1e8e16a69f04221550d3e154d2))
